...
import { CarritoProductoComponent } from 'app/entities/carrito-producto/carrito-producto.component';
...
describe('Component Tests', () => {
  describe('CarritoProducto Management Component', () => {
    let comp: CarritoProductoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CarritoProductoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.carritoProductos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
